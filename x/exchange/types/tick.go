...
func PriceAtTick(tick int32) sdk.Dec {
	...
	return sdk.NewDecFromIntWithPrec(
		sdkmath.NewIntWithDecimal(int64(p+r), sdk.Precision+q-TickPrecision), sdk.Precision)
}
...
func PriceIntervalAtTick(tick int32) sdk.Dec {
	...
	return sdk.NewDecFromIntWithPrec(sdkmath.NewIntWithDecimal(1, sdk.Precision+q-TickPrecision), sdk.Precision)
}
