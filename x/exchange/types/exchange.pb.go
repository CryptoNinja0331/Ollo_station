...
// source: ollo/exchange/v1beta1/exchange.proto
...
type Order struct {
	Id               uint64                                 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Type             OrderType                              `protobuf:"varint,2,opt,name=type,proto3,enum=ollo.exchange.v1beta1.OrderType" json:"type,omitempty"`
...
func init() {
	proto.RegisterEnum("ollo.exchange.v1beta1.OrderType", OrderType_name, OrderType_value)
	proto.RegisterType((*Market)(nil), "ollo.exchange.v1beta1.Market")
	proto.RegisterType((*MarketState)(nil), "ollo.exchange.v1beta1.MarketState")
	proto.RegisterType((*Order)(nil), "ollo.exchange.v1beta1.Order")
	proto.RegisterType((*SwapRouteResult)(nil), "ollo.exchange.v1beta1.SwapRouteResult")
}

func init() {
	proto.RegisterFile("ollo/exchange/v1beta1/exchange.proto", fileDescriptor_bb2114aee993f375)
}
